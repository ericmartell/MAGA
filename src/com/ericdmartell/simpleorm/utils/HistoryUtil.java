...
public class HistoryUtil {
	public static void recordHistory(final SimpleORMObject oldObjReference, final SimpleORMObject obj, ActionFactory loadPathFactory, DataSource dataSource) {
		final Throwable e = new Throwable();
		loadPathFactory.executorPool.submit(new Runnable() {
			@Override
			public void run() {
				SimpleORMObject oldObj = oldObjReference;
				SimpleORMObject object = obj;
